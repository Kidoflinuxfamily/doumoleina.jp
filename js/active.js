...
$('audio').on('play', function () {
    if (currentAudio && currentAudio !== this) {
        ...
        // Fix the UI for the paused audio (reset play button)
        let wrapper = $(currentAudio).closest('.audioplayer'); // may vary
        wrapper.removeClass('audioplayer-playing').addClass('audioplayer-stopped');
        wrapper.find('.audioplayer-playpause').removeClass('audioplayer-pause').addClass('audioplayer-play');
    }
    currentAudio = this;
});
